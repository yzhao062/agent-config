...
- Master CV: `Latex/sample_cv.tex`
- Included source fragment: `Latex/open-source.tex`
- Reference snapshot only: `Latex/open-source.json`
- Ignore as source: `out/`, `Latex/*.pdf`, and LaTeX intermediate files
