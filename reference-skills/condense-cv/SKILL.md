---
name: condense-cv
description: Create 1-page or 2-page CV variants from a longer master LaTeX CV. Use when the user asks for a short CV, concise CV, one-page CV, two-page CV, resume-style version, or a role-specific application CV derived from `Latex/sample_cv.tex` or another master CV source.
---
...
- In this repo, prefer editing `Latex/open-source.tex` selections rather than treating `Latex/open-source.json` as the source of truth.
