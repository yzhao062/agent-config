...
| Shared skills (`bibref-filler`, `bibref-verify`, `ci-mockup-figure`, `dual-pass-workflow`, `figure-prompt-builder`, `implement-review`, `my-router`, `prun`, `readme-polish`) | `skills/` directory (committed only) | sparse `git clone` |
